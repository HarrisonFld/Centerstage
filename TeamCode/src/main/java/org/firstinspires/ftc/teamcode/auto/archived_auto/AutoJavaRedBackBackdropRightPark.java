...
@Autonomous(name = "AutoJavaRedBackBackdropRightPark", group = "Archived")
public class AutoJavaRedBackBackdropRightPark extends AutoJavaRedBackBase {


    public AutoJavaRedBackBackdropRightPark() {
        super(false);
    }
