...
@Autonomous(name = "AutoJavaBlueBackRightPark", group = "Archived")
public class AutoJavaBlueBackRightPark extends AutoJavaBlueBackBase {


    public AutoJavaBlueBackRightPark() {
        super(true);
    }
