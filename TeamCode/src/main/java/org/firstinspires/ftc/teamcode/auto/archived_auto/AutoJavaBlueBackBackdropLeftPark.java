...
@Autonomous(name = "AutoJavaBlueBackBackdropLeftPark", group = "Archived")
public class AutoJavaBlueBackBackdropLeftPark extends AutoJavaBlueBackBase {


    public AutoJavaBlueBackBackdropLeftPark() {
        super(true);
    }
